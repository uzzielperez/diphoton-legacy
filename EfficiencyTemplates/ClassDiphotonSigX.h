...
#ifndef ${ClassDiphotonSignal}_h
#define ${ClassDiphotonSignal}_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ${ClassDiphotonSignal}(TTree *tree=0);
   virtual ~${ClassDiphotonSignal}();
...
#ifdef ${ClassDiphotonSignal}_cxx
${ClassDiphotonSignal}::${ClassDiphotonSignal}(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("root://cmseos.fnal.gov//eos/uscms${eosdsetdir}/*root");
      tree = chain;
#endif // SINGLE_TREE
...
${ClassDiphotonSignal}::~${ClassDiphotonSignal}()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ${ClassDiphotonSignal}::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ${ClassDiphotonSignal}::LoadTree(Long64_t entry)
{
...
void ${ClassDiphotonSignal}::Init(TTree *tree)
{
...
Bool_t ${ClassDiphotonSignal}::Notify()
{
...
void ${ClassDiphotonSignal}::Show(Long64_t entry)
{
...
Int_t ${ClassDiphotonSignal}::Cut(Long64_t entry)
{
...
#endif // #ifdef ${ClassDiphotonSignal}_cxx
